...
def coerce_to_standard(df, item_candidates, qty_candidates, price_candidates, fallback_store):
    df = clean_cols(df)
        ...
        if tables:
            for t in tables:
                try:
                    ...
                    norm = coerce_to_standard(df, item_candidates, qty_candidates, price_candidates, store_name)
